...
struct ___tracy_announced_source_location_data
{
...
typedef void (*___tracy_zone_toggle_callback)( void *data, ___tracy_announced_source_location_data *srcloc, uint64_t *enabled );
